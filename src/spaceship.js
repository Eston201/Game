...
function createRocket(){           // call this to create a new rocket
    var enemy = new THREE.Object3D();
    //const enemycolor = new THREE.color(0xe5e5e5);
    const enemymaterial = new THREE.MeshBasicMaterial({color:0x171717});
    const cpitmaterial = new THREE.MeshBasicMaterial({color:0x2674a1});
    const ringsmaterial = new THREE.MeshBasicMaterial({color:0x00ff04});
    const torumaterial = new THREE.MeshBasicMaterial({color:0x171717});
    const shootmaterial = new THREE.MeshBasicMaterial({color:0xffffff});
    const wingmat = new THREE.MeshBasicMaterial({color:0x520703});
    ...
    const blast2geo = new THREE.CylinderGeometry(0.1,0.3,3,20,20);
    const blaster2 = new THREE.Mesh(blast2geo,shootmaterial);
    blaster2.position.x = 2;
    blaster2.position.z = 1.65;
    blaster2.rotation.x = Math.PI/2;
    shooter.add(blaster2);
